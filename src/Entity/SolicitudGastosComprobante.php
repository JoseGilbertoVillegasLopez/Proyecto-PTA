...
use App\Repository\SolicitudGastosComprobanteRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: SolicitudGastosComprobanteRepository::class)]
#[ORM\Table(name: 'solicitud_gastos_comprobante')]
class SolicitudGastosComprobante
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToOne(inversedBy: 'comprobante')]
    #[ORM\JoinColumn(name: 'solicitud_id', referencedColumnName: 'id', nullable: false, unique: true, onDelete: 'CASCADE')]

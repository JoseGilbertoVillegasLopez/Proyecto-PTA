...
use App\Repository\ReporteIndicadorEvidenciaRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ReporteIndicadorEvidenciaRepository::class)]
#[ORM\Table(name: 'reporte_indicador_evidencia')]
class ReporteIndicadorEvidencia
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?ReporteIndicadorActividad $actividad = null;
    ...
    public function getActividad(): ?ReporteIndicadorActividad
    {
        return $this->actividad;
    }

    public function setActividad(?ReporteIndicadorActividad $actividad): static
    {

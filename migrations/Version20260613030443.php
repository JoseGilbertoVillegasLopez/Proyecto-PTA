 ...
 */
final class Version20260613030443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE puesto (id INT AUTO_INCREMENT NOT NULL, supervisor_directo_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, activo TINYINT(1) NOT NULL, INDEX IDX_47C3D2DE7EA96164 (supervisor_directo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE solicitud_gastos (id INT AUTO_INCREMENT NOT NULL, solicitante_id INT NOT NULL, tipo_solicitud_id INT NOT NULL, proceso_estrategico_id INT DEFAULT NULL, proceso_clave_id INT DEFAULT NULL, fecha_solicitud DATETIME NOT NULL, fecha_necesita DATE NOT NULL, transferencia_en_beneficio_de VARCHAR(255) NOT NULL, cta_clave_beneficiario VARCHAR(255) NOT NULL, por_concepto_de LONGTEXT NOT NULL, cantidad_total NUMERIC(10, 2) DEFAULT \'0.00\' NOT NULL, estado VARCHAR(20) DEFAULT \'pendiente\' NOT NULL, INDEX IDX_23AA7F5FC680A87 (solicitante_id), INDEX IDX_23AA7F5FAFEA88E4 (tipo_solicitud_id), INDEX IDX_23AA7F5F8DFC750A (proceso_estrategico_id), INDEX IDX_23AA7F5F9CF1B3C4 (proceso_clave_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
